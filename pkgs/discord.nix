  ...
  srcs = {
    x86_64-linux = {
      stable = fetchurl {
        ...
        hash = "sha256-/CcAq4ks2/GeTAsTvfADANCTFXSh/GkB0nZtYcRXhu0=";
      };
      ptb = fetchurl {
      ...
      canary = fetchurl {
        ...
        hash = "sha256-wiGtoX74Po0gngbf/S5PA5y/wDMxccPgk6lIAzEL4RY=";
      };
    ...
    x86_64-darwin = {
      ...
      canary = fetchurl {
        ...
        hash = "sha256-6oVb+Qg/KBr02frs48akx2wA8t2m/M20485x9CXl9QM=";
      };
      development = fetchurl {
