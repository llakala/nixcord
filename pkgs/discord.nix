  ...
  srcs = {
    x86_64-linux = {
      ...
      canary = fetchurl {
        ...
        hash = "sha256-6vo7vevxzVyZpLWBbTPS94wQU3pQtrMsxc91S02M42M=";
      };
    ...
    x86_64-darwin = {
      stable = fetchurl {
        ...
        hash = "sha256-ENlLPH0Ms1T2kX2QCzPcwyrSUcFT99AZ2C0mgsPI1zw=";
      };
      ptb = fetchurl {
        url = "https://ptb.dl2.discordapp.net/apps/osx/${versions.darwin.ptb}/DiscordPTB.dmg";
        hash = "sha256-ItE2Caw5WQ+bORsvne8pvvHVPgzrrez6NK+pkobBFsE=";
      };
      canary = fetchurl {
        url = "https://canary.dl2.discordapp.net/apps/osx/${versions.darwin.canary}/DiscordCanary.dmg";
        hash = "sha256-CdE4/d5mkkaS1avW7f95Ibzv9y/ZNPGhIVzZRQs+4Ek=";
      };
      development = fetchurl {
