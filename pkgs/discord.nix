  ...
  srcs = {
    x86_64-linux = {
      stable = fetchurl {
        ...
        hash = "sha256-WaKX+gdYebMB/6G5ZJjDJwjj9Rf0kSVZtZ7la0c4L8I=";
      };
      ptb = fetchurl {
      ...
      canary = fetchurl {
        ...
        hash = "sha256-jOWqc8PvNtzdAN/z8HiIOwfnESiwtwn671FxY9jCfP4=";
      };
