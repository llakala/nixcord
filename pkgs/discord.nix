  ...
  srcs = {
    x86_64-linux = {
      ...
      development = fetchurl {
        ...
        hash = "sha256-h9q4Sprg9Ihrkh+8M9pBBvQRMBcnW3Y8H22hSL4x7lw=";
      };
    };
    x86_64-darwin = {
      stable = fetchurl {
      ...
      ptb = fetchurl {
        ...
        hash = "sha256-YPeXHGUALJGniIt9O6Cje++9YR4ufjvwu3z9foSM6H0=";
      };
      canary = fetchurl {
        url = "https://canary.dl2.discordapp.net/apps/osx/${versions.darwin.canary}/DiscordCanary.dmg";
        hash = "sha256-aLADniMXglOyR+JfwoCK7vlpaAB81LtZgaldD1+BTm8=";
      };
      development = fetchurl {
