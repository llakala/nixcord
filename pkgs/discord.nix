  ...
  srcs = {
    x86_64-linux = {
      ...
      development = fetchurl {
        ...
        hash = "sha256-8GTYu6ylSP84uJ6lbKx+2VU5wCLkNFvpSXNffm9mtcg=";
      };
    };
    x86_64-darwin = {
      stable = fetchurl {
        url = "https://stable.dl2.discordapp.net/apps/osx/${versions.darwin.stable}/Discord.dmg";
        hash = "sha256-xbabHSer1W1hDNthc7RXXshJcaobv5GHXpkshbrTz/c=";
      };
      ptb = fetchurl {
      ...
      canary = fetchurl {
        ...
        hash = "sha256-TPH7zCzS7mfZwPQnic4fB34hcoIB8MCowZfo02DX3jI=";
      };
      development = fetchurl {
        url = "https://development.dl2.discordapp.net/apps/osx/${versions.darwin.development}/DiscordDevelopment.dmg";
        hash = "sha256-D3JS4T17vRNmMDYQTReuY1A8pNLyoPFfrK974mChBG0=";
      };
    };
