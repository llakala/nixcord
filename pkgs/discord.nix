  ...
  srcs = {
    x86_64-linux = {
      ...
      canary = fetchurl {
        ...
        hash = "sha256-W/OeSrxEckyRptANpP+9LEfzit0ST+4pexwvEGIbYOc=";
      };
    ...
    x86_64-darwin = {
      ...
      ptb = fetchurl {
        ...
        hash = "sha256-Y7YifSdXlZzcftCRATf881cSvOIgmHLgGzydVdmE3nk=";
      };
      canary = fetchurl {
        url = "https://canary.dl2.discordapp.net/apps/osx/${versions.darwin.canary}/DiscordCanary.dmg";
        hash = "sha256-PF9gE77y6cQO4fw8JAr4X22NFJQv2rcn7gRkptanl8g=";
      };
      development = fetchurl {
