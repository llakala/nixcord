  ...
  srcs = {
    x86_64-linux = {
      ...
      canary = fetchurl {
        ...
        hash = "sha256-vykDfi4tepnFnAuF8fVt7pEAlydsDHw+WJ+776Oy8Zw=";
      };
      development = fetchurl {
        ...
        hash = "sha256-Qq2N0KscWA8gC8oAclP0mWVGvE8osooW6yYB/DCZaGk=";
      };
    };
    x86_64-darwin = {
      stable = fetchurl {
      ...
      development = fetchurl {
        ...
        hash = "sha256-zARk5fFyzWTAszzvFPGtEvG4+SCsCxK82onoDK7hfiA=";
      };
    };
