  ...
  srcs = {
    x86_64-linux = {
      ...
      canary = fetchurl {
        ...
        hash = "sha256-crNL8BWalcH3/dgkLI6ni31V0xnSRUIRITV26LwiWAw=";
      };
    ...
    x86_64-darwin = {
      stable = fetchurl {
        ...
        hash = "sha256-GjrF51bp1sEp+UBxOyH5HJhSaSIm2OMzVBPYlGTEFSU=";
      };
      ptb = fetchurl {
      ...
      canary = fetchurl {
        ...
        hash = "sha256-pVBGdTW/dHGzQp1eqhpabeDmzzBmrb+7WuluzmQvPEM=";
      };
      development = fetchurl {
        url = "https://development.dl2.discordapp.net/apps/osx/${versions.darwin.development}/DiscordDevelopment.dmg";
        hash = "sha256-zX/aMuBZz3anHJPKWWLtLY/4Y/V9XyYDMLsQi/5aA0s=";
      };
    };
