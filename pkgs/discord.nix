  ...
  srcs = {
    x86_64-linux = {
      ...
      canary = fetchurl {
        ...
        hash = "sha256-hhrjKkXnhHm8gntPMGjst1eLu8xqube73lnbW5TEINY=";
      };
      development = fetchurl {
        ...
        hash = "sha256-1zlRLOxWUA7QNAMi2SRWCdnx1dbmkwWQSCl7Pyexoac=";
      };
    };
    x86_64-darwin = {
      stable = fetchurl {
      ...
      canary = fetchurl {
        ...
        hash = "sha256-bBimaZYUjkd7MwiqJiNjgQpiBOEUAVhTFOoQ/cnR+K0=";
      };
      development = fetchurl {
